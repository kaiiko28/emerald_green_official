...
<div @if ($mypayouts->status == 'Pending')
    ...
    @endif>
    <h2 style="padding-bottom:0;"><strong class="text-left">REQUEST PAYOUT {{$new}}</strong>
        <span
            @if ($mypayouts->status == 'Pending')
                class="pull-right text-right text-danger"
            @else
                class="pull-right text-right text-warning"
            @endif style="float: right;">
                                    ...
                                    <div class="col-md-9">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="invoice-address">
                                                        ...
                                                        <table class="table table-striped text-left">
                                                            ...
                                                            <tr>
                                                                <td><strong>Payout Source:</strong></td>
                                                                <td class="text-right">{{$mypayouts->source}}</td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <h5 class="text-center" style="text-align:left; padding: 10px;">Account Number: <span class="pull-right bg-primary h3" style="padding: 0 10px;"> {{$mypayouts->acc_number}} </span></h5>
