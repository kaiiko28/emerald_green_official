...
<!-- Mirrored from preview.oklerthemes.com/porto-admin/2.2.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 May 2019 03:00:22 GMT -->
<head>
		...
		<!-- Specific Page Vendor CSS -->		<link rel="stylesheet" href="vendor/owl.carousel/assets/owl.carousel.css" />		<link rel="stylesheet" href="vendor/owl.carousel/assets/owl.theme.default.css" />
	...
	<body>
						...
						<div class="container container-with-sidebar">
							<div class="row center">
								<div class="col-md-12 mb-4">
									...
									<a class="btn btn-3d btn-xl mt-4 mb-5" href="layouts-default.html" style="background-color: #383f48; border-color: #383f48 #383f48 #22262b; color: #fff;">VIEW MAIN LAYOUT <i class="ml-4 fas fa-long-arrow-alt-right"></i></a>
								</div>
							</div>
							...
							<div class="row justify-content-center">
								<div class="col-lg-6 mt-3">
									...
									<ul class="list list-icons list-style-none text-dark text-4 pl-none mb-2 pb-2 pr-3">
										<li class="mb-1"><i class="fas fa-check text-primary text-4 mt-1 mr-1"></i> <strong>The #1 Selling HTML Site Template on ThemeForest</strong></li>
										<li class="mb-1"><i class="fas fa-check text-primary text-4 mt-1 mr-1"></i> <strong>50+ Demos Ready to Use</strong></li>
										<li class="mb-1"><i class="fas fa-check text-primary text-4 mt-1 mr-1"></i> <strong>Code Integration - Admin features from Admin on Front-End</strong></li>
									</ul>
							...
							<div class="row">
								...
								<div class="col-xl-3">
									<div class="call-to-action-btn float-right-xl center mt-1 pt-1 mt-xl-5 pt-xl-4">
										<a href="https://themeforest.net/item/porto-admin-responsive-html5-template/8539472" target="_blank" class="btn btn-primary btn-lg mb-3"><i class="fas fa-cark mr-1"></i> BUY PORTO NOW - $24</a>
		...
		<!-- Specific Page Vendor -->		<script src="vendor/jquery-appear/jquery.appear.js"></script>		<script src="vendor/owl.carousel/owl.carousel.js"></script>		<script src="vendor/isotope/isotope.js"></script>
...
<!-- Mirrored from preview.oklerthemes.com/porto-admin/2.2.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 May 2019 03:00:29 GMT -->
</html>